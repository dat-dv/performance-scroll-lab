      ...
      <TechnicalIntro
        ...
        challenges={[
          ...
          },
          {
            ...
            description:
              "Việc append hàng nghìn card ngang mà không tối ưu sẽ làm vỡ giao diện và tốn RAM.",
          },
        ]}
        solutions={[
          {
        ...
        points={[
          {
            ...
            description:
              "Để trình duyệt hiểu được dải scroll ngang khổng lồ, ta cần set width cho container bằng (itemWidth * itemCount) ngay lập tức.",
          },
          {
            title: "Nhảy Index O(1)",
            colorClass: "text-emerald-600 dark:text-emerald-400",
            description:
              "Biết width cố định giúp ta tính ngay được startIndex chỉ bằng phép chia scrollLeft / itemWidth, thay vì phải đo từng card một.",
          },
          {
            title: "TranslateX chuẩn xác",
            colorClass: "text-purple-600 dark:text-purple-400",
            description:
              "Hệ thống dùng 'translateX' để dịch chuyển dải item. Vị trí dịch chuyển phải khớp tuyệt đối với số lượng item đã bị ẩn đi.",
          },
          {
            title: "Performance over Observers",
            colorClass: "text-amber-600 dark:text-amber-400",
            description:
              "IntersectionObserver quá chậm để xử lý hàng ngàn item theo thời gian thực (real-time). Math là giải pháp tối ưu cho mọi loại virtualization.",
          },
        ]}
      />
    </>
