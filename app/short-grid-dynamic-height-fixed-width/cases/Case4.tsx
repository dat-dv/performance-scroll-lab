        ...
        <div className="space-y-12">
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-slate-500 dark:text-slate-400">
              - Các tình huống trước ta sử dụng grid-cols-3, grid-cols-4, grid-cols-6 để chia cột
              nhưng nó có hạn chế items-stretch tuy nhiên nếu tắt đi bằng item-start thì nó sẽ có
              những khoảng trống giữa các row nhìn rất xấu.
              <br /> - Vậy chúng ta sẽ tiếp cận bằng cách khác không dùng grid nữa mà dùng columns
              kết hợp với bread inside avoid để cho đẹp hơn. bằng cách dùng columns-1, columns-2,
              columns-3 tức là ở desktop nó sẽ cố gắng render để được 3 dòng (tức là 3 items trên 1
              columns), còn lại nó sẽ đẩy sang column tiếp
            </p>
          </div>
          <TechnicalDeepDive
